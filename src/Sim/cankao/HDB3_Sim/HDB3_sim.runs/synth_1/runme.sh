...
HD_PWD='D:/Desktop/HDB3_Sim/HDB3_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdb3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdb3_top.tcl
