...
HD_PWD='D:/Desktop/HDB3_Sim/HDB3_sim.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdb3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdb3_top.tcl -notrace
